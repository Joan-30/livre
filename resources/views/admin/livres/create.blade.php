...
<head>
    ...
    <title>Lectura Innov – Ajouter un Livre</title>
...
<main class="max-w-4xl mx-auto px-4 py-12">
    <header class="mb-10">
        ...
        <p class="text-gray-500 dark:text-gray-400">Enrichissez le moteur de recommandation avec une nouvelle œuvre.</p>
    </header>

    <div class="glass-panel border border-white/20 dark:border-gray-800/80 rounded-3xl p-8 shadow-2xl dark:shadow-black/50">
        <form method="POST" action="{{ route('admin.livres.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div class="flex items-start gap-4">
                        <input type="text" name="tags_ambiance" id="tags_ambiance" value="{{ old('tags_ambiance') }}" required
            ...
            <div class="flex justify-end pt-4 border-t border-gray-200 dark:border-gray-800">
                <button type="submit" class="px-8 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-bold rounded-xl shadow-lg shadow-indigo-500/30 hover:-translate-y-0.5 hover:shadow-xl transition-all active:scale-95 text-sm">
